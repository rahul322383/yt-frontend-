...
//                 </CardTitle>
//                 <CardDescription className="text-sm sm:text-base">
//                   Your social media statistics and engagement
//                 </CardDescription>
//               </CardHeader>
//               <CardContent>
...
//                     <span className="text-xl font-bold mt-1">1.2k</span>
...
//                     <span className="text-xl font-bold mt-1">856</span>
//                     <span className="text-xs text-muted-foreground">Followers</span>
//                   </div>
//                   <div className="flex flex-col items-center p-4 rounded-lg bg-muted/20">
//                     <div className="p-3 rounded-full bg-blue-100 mb-2">
...
//                     <span className="text-xl font-bold mt-1">543</span>
...
//                     <span className="text-xl font-bold mt-1">2.4k</span>
//                     <span className="text-xs text-muted-foreground">Followers</span>
//                   </div>
//                 </div>
//               </CardContent>
...
//                   {watch("interests")?.slice(0, 3).map((interest) => (
//                     <Card key={interest} className="hover:shadow-md transition-shadow">
//                       <CardHeader>
...
//                           Discover the latest trends and resources in {interest.toLowerCase()}.
//                         </p>
//                       </CardContent>
//                       <CardFooter>
//                         <Button variant="outline" size="sm" className="rounded-full">
...
//                         Based on your JavaScript skills, learning TypeScript would help you build more robust applications.
//                       </p>
//                       <div className="flex items-center gap-2">
...
//                     <CardContent>
//                       <p className="text-sm text-muted-foreground mb-3">
//                         Containerization would complement your backend skills and improve deployment workflows.
//                       </p>
//                       <div className="flex items-center gap-2">
//                         <Badge variant="outline" className="rounded-full">
//                           <Check className="w-3 h-3 mr-1" />
