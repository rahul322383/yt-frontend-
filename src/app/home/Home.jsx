    ...
    >
      <div className="bg-blue-250 dark:bg-gray-800 hover:shadow-lg transition-all overflow-hidden cursor-pointer hover:scale-105 rounded-lg shadow-sm">
        ...
        <div className="p-1">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            {video.views} views · {video.likeCount || 0} likes ·{" "}
          ...
          {auth.isAuthenticated ? (
            <>
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                />
                {showProfileDropdown && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 shadow-lg rounded-lg z-10 overflow-hidden profile-dropdown">
                    <div className="p-3 border-b border-gray-200 dark:border-gray-700">
