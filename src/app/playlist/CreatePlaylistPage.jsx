...
// import { Trash2, Pencil, Loader2, Plus, ChevronRight, X } from "lucide-react";
...
//         fetchPlaylists();
//       } else {
//         const res = await API.post("/users/playlist", formData);
//         const newPlaylistId = res?.data?.data?._id;
//         if (!newPlaylistId) throw new Error("No playlist ID returned");
//         toast.success("Playlist created successfully!");
//         setShowCreateModal(false);
//         navigate(`/playlists/edit/${newPlaylistId}`);
//       }
//     } catch (err) {
...
//               <Card className="mt-6">
//                 <CardHeader>
//                   <CardTitle className="text-xl">Videos in this Playlist</CardTitle>
//                 </CardHeader>
//                 <CardContent className="space-y-3">
//                   {playlistVideos.map((video) => (
//                     <div key={video._id} className="flex items-center justify-between p-2 border rounded">
...
//                       className="group relative overflow-hidden rounded-xl bg-white dark:bg-gray-800 shadow-md hover:shadow-lg border border-gray-200 dark:border-gray-700"
//                     >
//                       <div className="p-5">
