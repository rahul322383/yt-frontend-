...
const sizeClasses = {
  ...
  lg: { container: "w-40 h-40", icon: "w-8 h-8" },
  xl: { container: "w-48 h-48", icon: "w-10 h-10" }
};

export default function AvatarUpload({ avatarUrl, onUpload, onDelete, size = "lg", className = "" }) {
