...
const LoginPage = () => {
  ...
  const verifyOtp = async () => {
    ...
    try {
      const res = await API.post(
        `/users/sendemail/verify-otp`,
        { identifier: identifierValue, otp: otpValue },
        { withCredentials: true }
      );
          ...
          <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    {...register("identifier")}
                    className="w-full pl-10 pr-4 py-3 bg-white/5 text-white rounded-xl border border-white/10 hover:border-white/20 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 outline-none placeholder-white/40 transition-all duration-200"
                    aria-invalid={errors.identifier ? "true" : "false"}
                  />
                </div>
                {errors.identifier && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    {...register("password")}
                    className="w-full pl-10 pr-10 py-3 bg-white/5 text-white rounded-xl border border-white/10 hover:border-white/20 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 outline-none placeholder-white/40 transition-all duration-200"
                    aria-invalid={errors.password ? "true" : "false"}
                  />
                  <button
                    type="button"
              ...
              <motion.button
                type="submit"
                disabled={!isValid || loading}
                className="w-full flex justify-center items-center py-3 px-4 bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-gray-900 font-semibold rounded-xl shadow-lg transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed group"
                whileHover={{ scale: !isValid || loading ? 1 : 1.02 }}
                whileTap={{ scale: !isValid || loading ? 1 : 0.98 }}
              >
                {loading ? (
                  ...
                  <>
                    Login In <FaArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                  </>
                )}
              </motion.button>
            </form>
            ...
            {!otpSent ? (
              <div className="space-y-4">
                ...
                >
                  {otpLoading ? (
                    ...
                    <>
                      Send OTP <FaArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                    </>
                  )}
                </motion.button>
                <div className="text-center">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white/5 text-white rounded-xl border border-white/10 hover:border-white/20 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 outline-none placeholder-white/40 transition-all duration-200 text-center tracking-widest"
                    />
                  </div>
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: otpLoading || otpValue.length !== 6 ? 1 : 0.98 }}
                >
                  {otpLoading ? (
                    <>
                      <FaSpinner className="animate-spin mr-2" />
